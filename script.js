...
if (contactForm) {
  contactForm.addEventListener('submit', (e) => {
    ...
    if (name && email && message) {
      // Create mailto link
      const mailtoLink = `mailto:aparnauppala09@gmail.com?subject=Portfolio Contact - Message from ${encodeURIComponent(name)}&body=${encodeURIComponent(message)}%0D%0A%0D%0AFrom: ${encodeURIComponent(email)}`;
